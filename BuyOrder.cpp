...
#include <utility>
BuyOrder::BuyOrder(int userID, std::string stockID, double orderPrice, int orderQuantity)
        : Order(userID, std::move(stockID), orderPrice, orderQuantity){
}
